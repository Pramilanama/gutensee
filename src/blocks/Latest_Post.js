...
const DraggableItem = ({ id, index, moveItem, children }) => {
    ...
    return (
        <div ref={ref} style={{ opacity: isDragging ? 0.5 : 1, cursor: 'move', padding: '8px', border: '1px solid #ddd', marginBottom: '4px' }}>
            {children}
        </div>
    );
};
...
const BlockEdit=(props)=>{
    ...
    setAttributes({ uniqueid: 'gutenseeblog' +clientId.slice(0,8) });
    ...
    const blockPropscolor = useBlockProps(); 
   ...
   if (enableslider === true) {
    ...
    const enableoverlay=(bgImageOverlay===true)?'':'hide-overlay';
                ...
                <>
                    <div className="gutensee_block_content_section">                   
                        ...
                        <PanelBody initialOpen={false}  title={__('Post Content','gutensee')} className={'gutensee-panel-edit'}>
                            ...
                            <RadioControl
                                label={ __( 'Show:','gutensee' ) }
                                selected={ displayPostContentRadio }
                                options={ [
                                    { label: __( 'Excerpt','gutensee' ), value: 'excerpt' },
                                    {
                                        label: __( 'Full post','gutensee' ),
                                        value: 'full_post',
                                    },
                                ] }
                                onChange={ ( value ) =>
                            ...
                            { displayPostContent && displayPostContentRadio === 'excerpt' && (
                                <>
                                    <RangeControl
                                        label={ __( 'Max number of words in excerpt','gutensee' ) }
                                        value={ excerptLength }
                                        onChange={ ( value ) =>
                                    ...
                                    />
                                    <ToggleControl
                                        label={ __( 'Enable/Disable Post Button','gutensee' ) }
                                        checked={ disablebtn }
                                        onChange={ ( value ) =>
                                            setAttributes( { disablebtn: value } )
                                        }
                                    />
                                    ...
                                    {disablebtn &&(
                                        <>                                      
                                            <TextControl
                                                label={__('Button Label','gutensee')}               
                                                value={buttonlabel}
                                                onChange={(newtext) => setAttributes({ buttonlabel: newtext })}
                                            />
                                            <ToggleControl
                        ...
                        <PanelBody initialOpen={false}  title={__('Sorting and Filtering','gutensee')} className={'gutensee-panel-edit'}>
    ...
    if ( ! hasPosts ) {
        return (
            <div { ...blockProps } >
                { inspectorControls }
                <Placeholder icon={ pin } label={ __( 'Latest Posts','gutensee' ) }>
                    { ! Array.isArray( latestPosts ) ? (
                        <Spinner />
                    ) : (
                        __( 'No posts found.','gutensee' )
                    ) }
                </Placeholder>
            </div>
        );
    ...
    const layoutControls = [
        {
            icon: list,
            title: __( 'List view','gutensee' ),
            onClick: () => setAttributes( { postLayout: 'list' } ),
            isActive: postLayout === 'list',
        },
        {
            icon: grid,
            title: __( 'Grid view','gutensee' ),
        ...
        <>  { inspectorControls }
            ...
            <div id={advid}>
                <div  { ...blockProps } id={uniqueid}>
                    <div className={`${"post-query-loop"} ${Rowclass} ${"single-item"} ${uniqueid} ${advclass}`}>
                        { displayPosts.map( ( post, i ) => {
                            ...
                            const commentcount=findOcc(commentsCount,post.id);
                            
                            let sbtag=post.tags;
                            let sbcat=post.categories;
                            ...
                            const imageClasses = classnames( {
                                [`post-image wp-block-latest-posts__featured-image ${enableoverlay}`]: true,
                            ...
                            const needsReadMore =
                                ...
                                post.excerpt.raw === '';
                            const postclass = (renderFeaturedImage !=undefined) ? "post" :"post gutensee-remove-img";
                            ...
                            const sitelink=wp.data.select( 'core' ).getSite();
                            const postDate = wp.date.format("/Y/m", post.date);
                                                ...
                                                return <div class="post-meta">
                                                                ...
                                                                <>  
                                                                    { displayAuthor && currentAuthor && (
                                                                        <span class="author">
                                                                            { (authortype === 'image') ? (
                                                                                <>
                                                                                    <img width="1060" height="766" src={currentAuthor['avatar_urls'][24]} class="img-fluid" alt="user-1"/>
                                                                                </>
                                                                            ):(
                                                                                <>
                                                                            ...
                                                                            <a href={ currentAuthor.link } rel="noopener noreferrer" onClick={ showRedirectionPreventedNotice }>{ currentAuthor.name }</a>                                      
                                                                        </span>
                                                                        )
                                                                    }
                                                                </>
                                                            ...
                                                            { (displayCat ==true) &&(
                                                                <>
                                                                    <span class="tag-links"><i class="far fa-folder"></i>
                                                                        {sbcat.length > 1 && sbcat.map((sbcats,index)=>                                   
                                                                            (<>
                                                                                { categoriesList && categoriesList.map( (cat,index)=>
                                                                                    (<>
                                                                                        { sbcats==cat.id &&
                                                                                          <a href={cat.href} rel="noopener noreferrer" onClick={ showRedirectionPreventedNotice }>{cat.name}</a>
                                                                                        }                                                
                                                                                    </>)
                                                                                )} 
                                                            ...
                                                            { (displayComment ==true) &&(
                                                                <>
                                                                    ...
                                                                    <span class="comments-link"><i class="far fa-comment"></i><a  rel="noopener noreferrer" onClick={ showRedirectionPreventedNotice }>Comments({commentcount})</a></span>
                                                ...
                                                return <header class="post-entry-header">
                                                            {displayTitle &&(
                                                                <h3 class="post-entry-title">
                                                                    ...
                                                                    >
                                                                        { ! titleTrimmed ? __( '(no title)','gutensee' ) : null }
                                                                    </a>
                                                                </h3>
                                                            )}                                                  
                                                        </header>;
                                                ...
                                                return <div class="post-entry-content">
                                                            { displayPostContent &&
                                                                displayPostContentRadio === 'excerpt' && (
                                                                        <p class="post-excerpt-content wp-block-latest-posts__post-excerpt">{ postExcerpt }</p>
                                                                ) 
                                                            }
                                                            ...
                                                            {displayPostContent &&  displayPostContentRadio === 'excerpt' && disablebtn &&(
...
registerBlockType('gutensee/gutensee-latest-post',{
    title:__('Latest Post','gutensee'),
    icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300"><rect width="46" height="46" rx="0" ry="0" transform="matrix(1.605439 0 0 3.098807 208.272047 83.02069)" fill="none" stroke="#099" stroke-width="2"/><rect width="46" height="46" rx="0" ry="0" transform="matrix(1.605439 0 0 3.098807 208.272047 83.02069)" fill="none" stroke="#099" stroke-width="2"/><circle r="27.5" transform="matrix(.192257 0 0 0.187447 222.976441 115.753627)" fill="#099"/><line x1="22.83" y1="50" x2="77.17" y2="50" transform="matrix(.557292 0 0 1 228.293954 65.753627)" fill="none" stroke="#099" stroke-width="7" stroke-linecap="round" stroke-miterlimit="10"/><circle r="27.5" transform="matrix(.192257 0 0 0.187447 222.976441 145.386962)" fill="#099"/><circle r="27.5" transform="matrix(.192257 0 0 0.187447 222.976441 172.588865)" fill="#099"/><line x1="22.83" y1="50" x2="77.17" y2="50" transform="matrix(.557292 0 0 1 228.293954 95.386962)" fill="none" stroke="#099" stroke-width="7" stroke-linecap="round" stroke-miterlimit="10"/><line x1="22.83" y1="50" x2="77.17" y2="50" transform="matrix(.557292 0 0 1 228.293954 122.588865)" fill="none" stroke="#099" stroke-width="7" stroke-linecap="round" stroke-miterlimit="10"/><rect width="46" height="46" rx="0" ry="0" transform="matrix(1.605439 0 0 3.098807 208.272047 83.02069)" fill="none" stroke="#099" stroke-width="2"/><circle r="27.5" transform="matrix(.192257 0 0 0.187447 222.976441 115.753627)" fill="#099"/><line x1="22.83" y1="50" x2="77.17" y2="50" transform="matrix(.557292 0 0 1 228.293954 65.753627)" fill="none" stroke="#099" stroke-width="7" stroke-linecap="round" stroke-miterlimit="10"/><circle r="27.5" transform="matrix(.192257 0 0 0.187447 222.976441 145.386962)" fill="#099"/><circle r="27.5" transform="matrix(.192257 0 0 0.187447 222.976441 172.588865)" fill="#5483cc"/><line x1="22.83" y1="50" x2="77.17" y2="50" transform="matrix(.557292 0 0 1 228.293954 95.386962)" fill="none" stroke="#099" stroke-width="7" stroke-linecap="round" stroke-miterlimit="10"/><line x1="22.83" y1="50" x2="77.17" y2="50" transform="matrix(.557292 0 0 1 228.293954 122.588865)" fill="none" stroke="#099" stroke-width="7" stroke-linecap="round" stroke-miterlimit="10"/><rect width="46" height="46" rx="0" ry="0" transform="matrix(1.605439 0 0 3.098807 21.086286 83.02069)" fill="none" stroke="#099" stroke-width="2"/><rect width="46" height="46" rx="0" ry="0" transform="matrix(1.605439 0 0 3.098807 21.086286 83.02069)" fill="none" stroke="#099" stroke-width="2"/><rect width="46" height="46" rx="0" ry="0" transform="matrix(1.605439 0 0 3.098807 21.086286 83.02069)" fill="none" stroke="#099" stroke-width="2"/><circle r="27.5" transform="matrix(.192257 0 0 0.187447 35.79068 115.753627)" fill="#099"/><line x1="22.83" y1="50" x2="77.17" y2="50" transform="matrix(.557292 0 0 1 41.108193 65.753627)" fill="none" stroke="#099" stroke-width="7" stroke-linecap="round" stroke-miterlimit="10"/><circle r="27.5" transform="matrix(.192257 0 0 0.187447 35.79068 145.386962)" fill="#099"/><circle r="27.5" transform="matrix(.192257 0 0 0.187447 35.79068 172.588865)" fill="#5483cc"/><line x1="22.83" y1="50" x2="77.17" y2="50" transform="matrix(.557292 0 0 1 41.108193 95.386962)" fill="none" stroke="#099" stroke-width="7" stroke-linecap="round" stroke-miterlimit="10"/><line x1="22.83" y1="50" x2="77.17" y2="50" transform="matrix(.557292 0 0 1 41.108193 122.588865)" fill="none" stroke="#099" stroke-width="7" stroke-linecap="round" stroke-miterlimit="10"/><rect width="46" height="46" rx="0" ry="0" transform="matrix(1.605439 0 0 3.098807 21.086286 83.02069)" fill="none" stroke="#099" stroke-width="2"/><circle r="27.5" transform="matrix(.192257 0 0 0.187447 35.79068 115.753627)" fill="#099"/><line x1="22.83" y1="50" x2="77.17" y2="50" transform="matrix(.557292 0 0 1 41.108193 65.753627)" fill="none" stroke="#099" stroke-width="7" stroke-linecap="round" stroke-miterlimit="10"/><circle r="27.5" transform="matrix(.192257 0 0 0.187447 35.79068 145.386962)" fill="#099"/><circle r="27.5" transform="matrix(.192257 0 0 0.187447 35.79068 172.588865)" fill="#099"/><line x1="22.83" y1="50" x2="77.17" y2="50" transform="matrix(.557292 0 0 1 41.108193 95.386962)" fill="none" stroke="#099" stroke-width="7" stroke-linecap="round" stroke-miterlimit="10"/><line x1="22.83" y1="50" x2="77.17" y2="50" transform="matrix(.557292 0 0 1 41.108193 122.588865)" fill="none" stroke="#099" stroke-width="7" stroke-linecap="round" stroke-miterlimit="10"/><rect width="46" height="46" rx="0" ry="0" transform="matrix(1.605439 0 0 3.098807 113.074903 83.02069)" fill="none" stroke="#099" stroke-width="2"/><rect width="46" height="46" rx="0" ry="0" transform="matrix(1.605439 0 0 3.098807 113.074903 83.02069)" fill="none" stroke="#099" stroke-width="2"/><rect width="46" height="46" rx="0" ry="0" transform="matrix(1.605439 0 0 3.098807 113.074903 83.02069)" fill="none" stroke="#099" stroke-width="2"/><circle r="27.5" transform="matrix(.192257 0 0 0.187447 127.779297 115.753627)" fill="#099"/><line x1="22.83" y1="50" x2="77.17" y2="50" transform="matrix(.557292 0 0 1 133.09681 65.753627)" fill="none" stroke="#099" stroke-width="7" stroke-linecap="round" stroke-miterlimit="10"/><circle r="27.5" transform="matrix(.192257 0 0 0.187447 127.779297 145.386962)" fill="#099"/><circle r="27.5" transform="matrix(.192257 0 0 0.187447 127.779297 172.588865)" fill="#5483cc"/><line x1="22.83" y1="50" x2="77.17" y2="50" transform="matrix(.557292 0 0 1 133.09681 95.386962)" fill="none" stroke="#099" stroke-width="7" stroke-linecap="round" stroke-miterlimit="10"/><line x1="22.83" y1="50" x2="77.17" y2="50" transform="matrix(.557292 0 0 1 133.09681 122.588865)" fill="none" stroke="#099" stroke-width="7" stroke-linecap="round" stroke-miterlimit="10"/><rect width="46" height="46" rx="0" ry="0" transform="matrix(1.605439 0 0 3.098807 113.074903 83.02069)" fill="none" stroke="#099" stroke-width="2"/><circle r="27.5" transform="matrix(.192257 0 0 0.187447 127.779297 115.753627)" fill="#099"/><line x1="22.83" y1="50" x2="77.17" y2="50" transform="matrix(.557292 0 0 1 133.09681 65.753627)" fill="none" stroke="#099" stroke-width="7" stroke-linecap="round" stroke-miterlimit="10"/><circle r="27.5" transform="matrix(.192257 0 0 0.187447 127.779297 145.386962)" fill="#099"/><circle r="27.5" transform="matrix(.192257 0 0 0.187447 127.779297 172.588865)" fill="#099"/><line x1="22.83" y1="50" x2="77.17" y2="50" transform="matrix(.557292 0 0 1 133.09681 95.386962)" fill="none" stroke="#099" stroke-width="7" stroke-linecap="round" stroke-miterlimit="10"/><line x1="22.83" y1="50" x2="77.17" y2="50" transform="matrix(.557292 0 0 1 133.09681 122.588865)" fill="none" stroke="#099" stroke-width="7" stroke-linecap="round" stroke-miterlimit="10"/></svg>,
    category:'gutensee',
    example: {
        'attributes' : {
            'mode' : 'preview',
    ...
    keywords:['Gutensee Latest Posts','posts', 'latest posts','recent posts', 'post slider', 'slider'],
    attributes: {
        uniqueid:{
            type:'string',
        },
